/*
# TaruGuardians core schema (re-apply)

Builds the full data model: profiles, content, tasks, messages, schedule, notifications, app_settings.
All tables have RLS with strict ownership and admin-scoped policies.
*/
